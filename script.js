class SportsTeam {
    constructor(name, city, abbreviation, league, hasSportInLogo, hasAbInLogo) {
        this.name = name;
        this.city = city;
...
$(document).ready(function() {
    ...
    teamsBeta.set("MLB-BAL", new SportsTeam('Orioles', 'Baltimore', 'BAL', 'MLB', true, false));
    ...
    teamsBeta.set("MLB-MIA", new SportsTeam('Marlins', 'Miami', 'MIA', 'MLB', true, false));
    ...
    teamsBeta.set("MLB-OAK", new SportsTeam('Athletics', 'Oakland', 'OAK', 'MLB', false, false));
    ...
    teamsBeta.set("NBA-CLE", new SportsTeam('Cavaliers', 'Cleveland', 'CLE', 'NBA', false, false));
    teamsBeta.set("NBA-DAL", new SportsTeam('Mavericks', 'Dallas', 'DAL', 'NBA', true, false));
    ...
    teamsBeta.set("NBA-LAC", new SportsTeam('Clippers', 'Los Angeles', 'LAC', 'NBA', true, true));
    ...
    teamsBeta.set("NBA-MIN", new SportsTeam('Timberwolves', 'Minnesota', 'MIN', 'NBA', true, false));
    teamsBeta.set("NBA-NOP", new SportsTeam('Pelicans', 'New Orleans', 'NOP', 'NBA', true, false));
    teamsBeta.set("NBA-NYK", new SportsTeam('Knicks', 'New York', 'NYK', 'NBA', true, false));
    ...
    teamsBeta.set("NBA-PHI", new SportsTeam('76ers', 'Philadelphia', 'PHI', 'NBA', false, false));
    teamsBeta.set("NBA-PHX", new SportsTeam('Suns', 'Phoenix', 'PHX', 'NBA', true, false));
    teamsBeta.set("NBA-POR", new SportsTeam('Trail Blazers', 'Portland', 'POR', 'NBA', false, false));
    ...
    teamsBeta.set("NFL-JAX", new SportsTeam('Jaguars', 'Jackonville', 'JAX', 'NFL', false, false));
    ...
    teamsBeta.set("NFL-SF", new SportsTeam('49ers', 'San Fransisco', 'SF', 'NFL', false, true));
    teamsBeta.set("NFL-TB", new SportsTeam('Buccaneers', 'Tampa Bay', 'TB', 'NFL', true, false));
    ...
    teamsBeta.set("NHL-ARI", new SportsTeam('Coyotes', 'Arizona', 'ARI', 'NHL', true, false));
    ...
    teamsBeta.set("NHL-CAR", new SportsTeam('Hurricanes', 'Carolina', 'CAR', 'NHL', false, false));
    teamsBeta.set("NHL-CBJ", new SportsTeam('Blue Jackets', 'Columbus', 'CBJ', 'NHL', false, false));
    teamsBeta.set("NHL-CGY", new SportsTeam('Flames', 'Calgary', 'CGY', 'NHL', false, false));
    teamsBeta.set("NHL-CHI", new SportsTeam('Blackhawks', 'Chicago', 'CHI', 'NHL', false, false));
    teamsBeta.set("NHL-COL", new SportsTeam('Avalanche', 'Colorado', 'COL', 'NHL', true, false));
    teamsBeta.set("NHL-DAL", new SportsTeam('Stars', 'Dallas', 'DAL', 'NHL', false, false));
    teamsBeta.set("NHL-DET", new SportsTeam('Red Wings', 'Detroit', 'DET', 'NHL', false, false));
    ...
    teamsBeta.set("NHL-MTL", new SportsTeam('Canadiens', 'Montreal', 'MTL', 'NHL', false, false));
    teamsBeta.set("NHL-NJD", new SportsTeam('Devils', 'New Jersey', 'NJD', 'NHL', false, false));
    teamsBeta.set("NHL-NSH", new SportsTeam('Predators', 'Nashville', 'NSH', 'NHL', false, false));
    teamsBeta.set("NHL-NYI", new SportsTeam('Islanders', 'New York', 'NYI', 'NHL', true, false));
    teamsBeta.set("NHL-NYR", new SportsTeam('Rangers', 'New York', 'NYR', 'NHL', false, false));
    teamsBeta.set("NHL-OTT", new SportsTeam('Senators', 'Ottawa', 'OTT', 'NHL', false, false));
    teamsBeta.set("NHL-PHI", new SportsTeam('Flyers', 'Philadelphia', 'PHI', 'NHL', false, false));
    teamsBeta.set("NHL-PIT", new SportsTeam('Penguins', 'Pittsburgh', 'PIT', 'NHL', true, false));
    ...
    teamsBeta.set("NHL-TBL", new SportsTeam('Lightning', 'Tampa Bay', 'TBL', 'NHL', false, false));
    teamsBeta.set("NHL-TOR", new SportsTeam('Maple Leafs', 'Toronto', 'TOR', 'NHL', false, false));
    ...
    teamsBeta.set("NHL-WSH", new SportsTeam('Capitals', 'Washington', 'WSH', 'NHL', false, false));
    ...
    for (let [key, team] of teamsLoading) {
        if (counter < 20) {
            ...
            logos.push(`<img src="${fileName}" alt="${team.getName}">`);
            counter++;
        } else if (counter < 40) {
            let fileName = "img/" + team.generateFileName();
            logos2.push(`<img src="${fileName}" alt="${team.getName}">`);
            counter++;
        } else {
            break;
        }
    ...
    function createQuestion(team, qNum) {
       ...
       $('#nameDisplay').text('');
        ...
        teamNameInput.off('input').on('input', function() {
            ...
            var teamName = team.getName.toLowerCase();
            // Validate input & add score
            if (!lockBox && textBoxText === teamName || ((textBoxText == "as" || textBoxText == "a\'s") && teamName == "athletics")) {
